...
var PasswordFieldSet =  React.createClass({
  ...
  render: function() {
    var strengthBar = (<div className={'pure-u-' + (this.state.strength + 1) + '-5'} style={{height: "2em", background: "#eee"}}>{this.state.strength}</div>);
    var strengthText = names[this.state.strength];
